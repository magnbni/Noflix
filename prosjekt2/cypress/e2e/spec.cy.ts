...
describe("Test Filtration", () => {
  it("Filter after search", () => {
    ...
    cy.get(
      ":nth-child(1) > :nth-child(1) > :nth-child(1) > .MuiPaper-root > .MuiButtonBase-root > .MuiCardContent-root > .MuiTypography-h5",
    ).contains("The Regeneration");
    //Select drama
    cy.get(".MuiSelect-select").click();
    cy.get('[data-value="Drama"]').click();
    cy.get(
      ":nth-child(1) > :nth-child(1) > :nth-child(1) > .MuiPaper-root > .MuiButtonBase-root > .MuiCardContent-root > .MuiTypography-h5",
    ).contains("The Sealed Room");
    //Select family
    cy.get(".MuiSelect-select").click();
    cy.get('[data-value="Family"]').click();
    cy.get(
      ":nth-child(1) > :nth-child(1) > :nth-child(1) > .MuiPaper-root > .MuiButtonBase-root > .MuiCardContent-root > .MuiTypography-h5",
    ).contains("The Patchwork Girl");
    //Select adventure
    cy.get(".MuiSelect-select").click();
    cy.get('[data-value="Adventure"]').click();
    cy.get(
      ":nth-child(1) > :nth-child(1) > :nth-child(1) > .MuiPaper-root > .MuiButtonBase-root > .MuiCardContent-root > .MuiTypography-h5",
    ).contains("The Wonderful Wiz");
    //Select history
    cy.get(".MuiSelect-select").click();
    ...
    cy.get(
      ":nth-child(1) > :nth-child(1) > :nth-child(1) > .MuiPaper-root > .MuiButtonBase-root > .MuiCardContent-root > .MuiTypography-h5",
    ).contains("Alice the Toreador");
    //Select comedy
    cy.get(".MuiSelect-select").click();
    cy.get('[data-value="Comedy"]').click();
    cy.get(
      ":nth-child(1) > :nth-child(1) > :nth-child(1) > .MuiPaper-root > .MuiButtonBase-root > .MuiCardContent-root > .MuiTypography-h5",
    ).contains("The Magician's Cave");
    //Select documentary
    cy.get(".MuiSelect-select").click();
    ...
    cy.get(
      ":nth-child(1) > :nth-child(1) > :nth-child(1) > .MuiPaper-root > .MuiButtonBase-root > .MuiCardContent-root > .MuiTypography-h5",
    ).contains("The Birth of a");
    //Select western
    cy.get(".MuiSelect-select").click();
    cy.get('[data-value="Western"]').click();
    cy.get(
      ":nth-child(1) > :nth-child(1) > :nth-child(1) > .MuiPaper-root > .MuiButtonBase-root > .MuiCardContent-root > .MuiTypography-h5",
    ).contains("Algie, the Miner");
    //Select action
    cy.get(".MuiSelect-select").click();
    cy.get('[data-value="Action"]').click();
    cy.get(
      ":nth-child(1) > :nth-child(1) > :nth-child(1) > .MuiPaper-root > .MuiButtonBase-root > .MuiCardContent-root > .MuiTypography-h5",
    ).contains("The Perils of Pauli");
    //Select horror
    cy.get(".MuiSelect-select").click();
